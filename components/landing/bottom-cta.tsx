  ...
  return (
    <section className="border-t border-border px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Ready to walk in prepared?</h2>
        <p className="mt-4 text-lg text-muted-foreground">Join the first 50 buyers at launch pricing.</p>
